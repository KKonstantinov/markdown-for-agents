...
def markdown_after_request(app: Flask, options: MiddlewareOptions | None = None) -> None:
    ...
    @app.after_request
    def _convert_to_markdown(response: Response) -> Response:
        ...
        return _apply_conversion(response, opts)

    return None


def _apply_conversion(response: Response, opts: MiddlewareOptions) -> Response:
    """Convert the HTML response body to markdown and update headers."""
