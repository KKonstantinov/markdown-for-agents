...
Elements not listed above are treated as pass-through containers - their children are converted but the element itself produces no Markdown
syntax. This means content is never lost, even for unknown or custom elements.
